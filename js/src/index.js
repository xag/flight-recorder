...
export { boundaryOf, install, uninstall, clockAt, tool, wrap, query, queryOne, exec, sampleIndices, snapshot, missing, note, span, declare, tapePath, FORMAT_VERSION } from './record.js';
